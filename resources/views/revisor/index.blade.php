<x-layout>
    <header class="container-fluid px-4 py-5 titleHero">
        <section class="row">
            <div class="col-12">
                        ...
                        <div class="carousel-inner">
                            @foreach ($article_to_check->images as $key=>$image)
                                <div class="carousel-item active @if($loop->first) active @endif">
                                    <img src="{{ $image->getUrl(300, 300) }}" class="img-fluid" alt="Immagine {{$key +1}} dell'articolo {{$article_to_check->title}}">
                                </div>
                            @endforeach
                        </div>
            ...
            <section class="col-5">
                <div class="d-flex flex-column justify-content-between">
                    ...
                    <div class="d-flex justify-start">
                        <form class="me-3" action="{{route('accept', ['article' => $article_to_check])}}" method="POST">
                            @csrf
                            @method('PATCH')
